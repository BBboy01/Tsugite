...
function SelectEmpty({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "hidden w-full justify-center py-2 text-center text-sm text-oklch(0.556 0 0) group-data-empty/select-list:flex dark:text-oklch(0.708 0 0)",
        className,
      )}
      {...props}
    />
